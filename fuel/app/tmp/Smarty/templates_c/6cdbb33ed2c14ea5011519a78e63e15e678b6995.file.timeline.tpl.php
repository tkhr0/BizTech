<?php /* Smarty version Smarty-3.1.19-dev, created on 2014-09-19 17:30:34
...
" width="100%" alt="..."></a></li>   
          ...
          <form action="#" class="cheer-form">
            <input type="hidden" name="target-id" value="<?php echo $_smarty_tpl->tpl_vars['cheer_user']->value['id'];?>
" />
